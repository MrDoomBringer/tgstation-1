...
/datum/mind
	...
	///List of skills the user has ever leveled to legendary. Should not be used to keep track of currently known skills. Lazy list because it shouldnt be filled often
	var/list/skills_leveled_to_legendary
